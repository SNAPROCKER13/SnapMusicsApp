...
const Header = () => {
    ...
    return(
        <div className="w-full bg-white flex flex-row border-2 border-black items-center justify-between px-12 h-24">
            <div className="">
                <h1 className="text-3xl text-sky-400 font-bold">SNAPMUSICS</h1>
            </div>
            <div className="flex flex-row justify-center items-center">
                ...
                <button onClick={() => navigate('/')}className="border-2 bg-sky-400 rounded-lg h-max w-max text-white">Log Out</button>
            </div>
        </div>
    )
}
